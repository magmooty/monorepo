...
const generate = "typescript"; // typescript or i18n

// Governorates

if (generate === "typescript") {
  console.log("export enum Governorate {");
}
...
for (const governorate of governorates) {
  ...
  if (generate === "typescript") {
    console.log(
      `  ${governorate.governorate_name_en.replace(
        / /g,
        ""
